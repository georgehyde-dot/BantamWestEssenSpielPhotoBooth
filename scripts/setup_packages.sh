...
echo ""
echo "Next steps:"
echo "1. Configure DNP DS620 printer:"
echo "   sudo ./setup_printer.sh"
echo ""
echo "2. If you added the user to groups, log out and back in"
echo ""
echo "3. Connect Canon EOS Rebel T7 and verify detection:"
echo "   gphoto2 --auto-detect"
echo ""
echo "4. Copy font files to /home/user "
echo "   then connect to the instance and copy them to /usr/local/share/fonts/"
echo ""
